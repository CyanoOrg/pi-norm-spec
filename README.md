...
> Status: `0.2.0-alpha.1` bootstrap. Identity/status paths exist; production
> injection, enforcement, validation feedback, and packaging are incomplete.

See `AGENTS.md`, `docs/ARCHITECTURE.md`, and
`docs/planning/v0.2-execution.md` before contributing.
